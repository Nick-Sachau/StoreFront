...
namespace StoreFront.DATA.EF.Models//Metadata
{
    ...
    public class PokeBallsMetadata 
    {
        [Required]
        [StringLength(50, ErrorMessage = "*Cannot exceed 50 characters")]
        [Display(Name = "Pokeball")]
        public string PokeballName { get; set; } = null!;

        [StringLength(200, ErrorMessage = "*Cannot exceed 50 characters")]
        public string? Description { get; set; }

        [StringLength(75, ErrorMessage = "*Cannot exceed 50 characters")]
